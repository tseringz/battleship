...
//               (getId > shipAxis[1] - 3 && getId < shipAxis[1]) ||
//               (getId > shipAxis[0] - 3 && getId < shipAxis[0]) ||
//               (getId > shipAxis[1] + 10 - 3 && getId < shipAxis[1] + 10) ||
//               (getId > shipAxis[1] + 20 - 3 && getId < shipAxis[1] + 20) ||
//               (getId > shipAxis[1] + 30 - 3 && getId < shipAxis[1] + 30)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
//               (getId > shipAxis[0] - 2 && getId < shipAxis[0]) ||
//               (getId > shipAxis[3] - 2 && getId < shipAxis[3]) ||
//               (getId > shipAxis[1] + 10 - 2 && getId < shipAxis[1] + 10) ||
//               (getId > shipAxis[1] + 20 - 2 && getId < shipAxis[1] + 20) ||
//               (getId > shipAxis[1] + 30 - 2 && getId < shipAxis[1] + 30)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
//               (getId < shipAxis[0] - 5 && getId > shipAxis[0] - 11) ||
//               (getId < shipAxis[0] - 15 && getId > shipAxis[0] - 21) ||
//               (getId < shipAxis[1] - 4 && getId > shipAxis[1] - 11) ||
//               (getId < shipAxis[1] - 14 && getId > shipAxis[1] - 21)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
//               getId === shipAxis[1] - 10 ||
//               getId === shipAxis[1] - 20 ||
//               (getId < shipAxis[2] - 7 && getId > shipAxis[2] - 11) ||
//               (getId < shipAxis[2] - 17 && getId > shipAxis[2] - 21)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
//               getId === shipAxis[0] - 10 ||
//               (getId < shipAxis[0] - 5 && getId > shipAxis[0] - 11) ||
//               (getId < shipAxis[2] - 7 && getId > shipAxis[2] - 10) ||
//               (getId < shipAxis[1] - 6 && getId > shipAxis[1] - 10) ||
//               (getId < shipAxis[3] - 7 && getId > shipAxis[3] - 10)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
//               (getId < shipAxis[0] - 5 && getId > shipAxis[0] - 11) ||
//               (getId < shipAxis[0] - 15 && getId > shipAxis[0] - 21) ||
//               (getId < shipAxis[3] - 17 && getId > shipAxis[3] - 21)
//             ) {
//               this.style.backgroundColor = 'red';
//               this.style.cursor = 'not-allowed';
//             } else {
...
function gameBoard() {
  ...
  let receivedAttack = function(coordinate) {
    coordinates[coordinate] = true;
    biggerShip.ship.hitCounter.push(coordinate);
    missAttack.push(coordinate);
  }
}
